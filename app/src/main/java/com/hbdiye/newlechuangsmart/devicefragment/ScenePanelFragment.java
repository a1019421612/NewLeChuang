...
public class ScenePanelFragment extends BaseFragment implements View.OnClickListener {
    ...
    private LinearLayout ll_scene_1, ll_scene_2, ll_scene_3, ll_scene_4;
...
//        args.putInt(ARGS_PAGE, page);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tv_scene_panel_name = view.findViewById(R.id.tv_scene_panel_name);
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        if (kaiGuanBean.errcode.equals("0")) {
                            ...
                            tv_scene_panel_name.setText(name);
                        }
                    }
                });
    }
