...
public class ChoiceZhujiItemAdapter extends BaseAdapter {
    private Context context;
    private List<GateWayBean.RoomList.GatewayList> mList;
    private int icon;
    public ChoiceZhujiItemAdapter(Context context, List<GateWayBean.RoomList.GatewayList> mList, int icon) {
