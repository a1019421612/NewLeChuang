...
public class TestDeviceAdapter extends BaseSectionQuickAdapter<SecneSectionBean,BaseViewHolder>{
    public TestDeviceAdapter(int layoutResId, int sectionHeadResId, List<SecneSectionBean> data) {
