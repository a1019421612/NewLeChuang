...
import static com.hbdiye.newlechuangsmart.activity.SeriesNumSearchActivity.BUNDE_SERIANO;
import static com.hbdiye.newlechuangsmart.activity.SeriesNumSearchActivity.BUNDE_VERYCODE;
import static com.hbdiye.newlechuangsmart.devicelist.AutoWifiNetConfigActivity.WIFI_PASSWORD;
import static com.hbdiye.newlechuangsmart.devicelist.AutoWifiNetConfigActivity.WIFI_SSID;
        ...
        mAddTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mAddTv.getText().toString().trim().equalsIgnoreCase(getString(R.string.complete_txt))){
                    // TODO: 2018/6/6 完成
                    Intent intent = new Intent(APWifiConfigActivity.this, CameraListActivity.class);
