...
public class CommentLinkageView extends LinearLayout {
    ...
    public CommentLinkageView(Context context) {
        super(context);
        init();
    }

    private void init() {
        View view = View.inflate(getContext(), R.layout.linkage_device_item, this);
        ButterKnife.bind(this, view);
    }

    public CommentLinkageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
