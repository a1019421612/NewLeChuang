...
import com.hbdiye.newlechuangsmart.adapter.HWDeviceIconAdapter;
 ...
 *
 */
public class HwIconPopwindow extends PopupWindow {
	private Context context;
	private LayoutInflater inflater;
	private View view;
	private BaseQuickAdapter.OnItemClickListener clickListener;
	private HWDeviceIconAdapter adapter;
	private List<Integer> mList;
	private List<String> list;
   public HwIconPopwindow(Context context, List<Integer> mList, List<String> list,BaseQuickAdapter.OnItemClickListener clickListener){
   ...
   public void initView(){
	   ...
	   adapter=new HWDeviceIconAdapter(mList,list);
