...
public class BoxActivity extends HwBaseActivity {

    @BindView(R.id.gridview)
    MyGridView gridview;

    private int icon[] = {R.mipmap.zhuye, R.mipmap.caidan, R.mipmap.fanhui};
    //图标下的文字
    private String name[] = {"主页", "菜单", "返回"};
...
//              {"主页(没有)", "菜单(没有)", "返回"};
    ...
    @OnClick({R.id.iv_xiangshang, R.id.iv_xiangxia, R.id.iv_xiangzuo, R.id.iv_xiangyou, R.id.tv_ok,
            R.id.iv_voice_add, R.id.iv_voice_reduce, R.id.iv_kaiguan})
