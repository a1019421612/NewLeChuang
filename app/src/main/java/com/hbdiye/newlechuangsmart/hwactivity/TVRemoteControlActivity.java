...
public class TVRemoteControlActivity extends HwBaseActivity {
    ...
    private int icon[] = {R.mipmap.zhuye, R.mipmap.caidan, R.mipmap.shuzijian,
            ...
            R.mipmap.kuozhanjian, R.mipmap.fanhui, R.mipmap.kaiguan};
    //图标下的文字
    private String name[] = {"主页", "菜单", "数字键", "自动换台", "频道列表", "静音","扩展键", "返回","开关"};
    ...
    AdapterView.OnItemClickListener gvListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            switch (position) {
//                {"主页", "菜单", "数字键", "自动换台", "频道列表", "静音","扩展键", "返回","开关"};
                case 0:
...
//                    setHongWai(getPulse("channel_up"));
    ...
    @OnClick({R.id.iv_program_add, R.id.iv_program_reduce, R.id.iv_xiangshang, R.id.iv_xiangxia, R.id.tv_ok,
            R.id.iv_xiangzuo, R.id.iv_xiangyou, R.id.iv_voice_add, R.id.iv_voice_reduce})
