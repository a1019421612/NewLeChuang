...
public class PublicRemoteControlActivity extends HwBaseActivity {

    @BindView(R.id.gridview)
    MyGridView gridview;

    private int icon[] = {R.mipmap.moshi, R.mipmap.kuozhanjian, R.mipmap.kaiguan};
    //图标下的文字
    private String name[] = {"模式", "扩展", "开关"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_public_remote_control);
