 ...
 *******************************************************************************/
package com.hbdiye.newlechuangsmart.widget.pulltorefresh;
...
public final class OverscrollHelper {
    ...
    public static void overScrollBy(final PullToRefreshBase<?> view, final int deltaX, final int scrollX,
        ...
        if (view.isPullToRefreshOverScrollEnabled() && !view.isRefreshing()) {
            final IPullToRefresh.Mode mode = view.getMode();
                ...
                if (newScrollValue < (0 - fuzzyThreshold)) {
                    ...
                    if (mode.showHeaderLoadingLayout()) {
                        ...
                        if (currentScrollValue == 0) {
                            view.setState(IPullToRefresh.State.OVERSCROLLING);
                        }
                    ...
                    view.setState(IPullToRefresh.State.RESET);
                }
            } else if (isTouchEvent && IPullToRefresh.State.OVERSCROLLING == view.getState()) {
