...
import com.hbdiye.newlechuangsmart.devicelist.AutoWifiConnectingActivity;
import com.hbdiye.newlechuangsmart.devicelist.AutoWifiPrepareStepOneActivity;
import com.hbdiye.newlechuangsmart.devicelist.DeviceModel;
...
public class SeriesNumSearchActivity extends RootActivity implements View.OnClickListener/*, OnAuthListener*/ {
    ...
    private void initTitleBar() {
        tv_title.setText(R.string.result_txt);
    ...
    private void init() {
        ...
        if (mBundle != null) {
            ...
            mDeviceType = mBundle.getString("device_type");
    ...
    private void addQueryCameraAddVerifyCode() {
        ...
        new Thread() {
            public void run() {
                ...
                try {
                    boolean result = EZOpenSDK.getInstance().addDevice(mSerialNoStr, mVerifyCode);
...
//                    }
    ...
    private void showInputSerialNo() {
        ...
        tv_title.setText(R.string.serial_input_text);
    ...
    private void showQueryingCamera() {
        ...
        errorPage.setVisibility(View.GONE);
        mCameraListLy.setVisibility(View.GONE);
        tv_title.setText(R.string.scan_device_search);
