package com.hbdiye.newlechuangsmart.devicemgt;
                ...
                public void onClick(View v) {
                    ...
                    switch (v.getId()) {
                        ...
                        case R.id.ez_device_serial_layout:
                            try {
                                if (EZOpenSDK.getInstance() instanceof EZOpenSDK) {
...
//            tv.setGravity(Gravity.CENTER);
    ...
    private class GetDeviceInfoTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
        	try {
        		mDeviceVersion = EZOpenSDK.getInstance().getDeviceVersion(mEZDeviceInfo.getDeviceSerial());
        		return true;
        	} catch (BaseException e) {;
                ErrorInfo errorInfo = (ErrorInfo) e.getObject();
...
//            }
    ...
    private class SetDefenceTask extends AsyncTask<Boolean, Void, Boolean> {
		...
		protected Boolean doInBackground(Boolean... params) {
			...
			try {
				result = EZOpenSDK.getInstance().setDefence(mEZDeviceInfo.getDeviceSerial(), bSetDefence? EZConstants.EZDefenceStatus.EZDefence_IPC_OPEN:
    ...
    private class OpenEncryptTask extends AsyncTask<Boolean, Void, Boolean> {
        ...
        protected Boolean doInBackground(Boolean... params) {
            ...
            try {
            	EZOpenSDK.getInstance().setDeviceEncryptStatus(mEZDeviceInfo.getDeviceSerial(),mValidateCode,isEnableEncrypt);
...
//            	EZCameraInfo cameraInfo = params[0];
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                ...
                Intent intent = new Intent(EZDeviceSettingActivity.this, CameraListActivity.class);
